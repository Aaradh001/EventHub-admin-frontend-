...
const ClientDetails = (props) => {
    ...
    useEffect(() => {
        fetchUsers(BASE_URL + `/admin-control/client-management/client/${parseInt(clientId)}`);
      }, []);
                            ...
                            <div className="h-full flex flex-col items-center p-3 bg-white p-3 border-t-4 border-green-400">
                                <div className="border border-gray-500 flex max-w-150 overflow-hidden sm:rounded-full">
                                    <img className="h-auto w-full mx-auto"
                                        src={clientDetail.profile_pic?clientDetail.profile_pic:userImg}
                                        alt=""/>
                                </div>
                                ...
                                <h1 className="text-gray-900 font-bold text-xl leading-8 my-1">{clientDetail? clientDetail.client.username:'...'}</h1>
                                ...
                                <div className="text-gray-700">
                                    <div className="grid md:grid-cols-2 text-sm">
                                        <div className="grid grid-cols-2">
                                            ...
                                            <div className="px-4 py-2">{clientDetail.first_name}</div>
                                        </div>
                                        <div className="grid grid-cols-2">
                                            <div className="px-4 py-2 font-semibold">Last Name</div>
                                            <div className="px-4 py-2">{clientDetail.last_name}</div>
                                        </div>
                                        {/* <div className="grid grid-cols-2">
