...
const EditSidebar = () => {
    return (
        // Edit Product Drawer
        <div id="drawer-update-product-default" className="fixed top-3.5 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
            ...
            <form action="#">
                <div className="space-y-4">
                    ...
                    <div>
                        <label for="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Technology</label>
